...
namespace LensLooker.Data.Migrations
{
    ...
    [Migration("20220620104221_AddIndexForCommonPhotoFields")]
    partial class AddIndexForCommonPhotoFields
    {
            ...
            modelBuilder.Entity("LensLooker.Data.Models.Photo", b =>
                {
                    ...
                    b.HasIndex("PhotoId", "LensId", "IsExifFetched");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("PhotoId", "LensId", "IsExifFetched"), new[] { "CameraId" });
